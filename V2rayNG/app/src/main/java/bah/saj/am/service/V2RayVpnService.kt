...
import bah.saj.am.AppConfig.LOOPBACK
import bah.saj.am.BuildConfig
import bah.saj.am.handler.MmkvManager
import bah.saj.am.handler.NotificationManager
import bah.saj.am.handler.SettingsManager
import bah.saj.am.handler.V2RayServiceManager
import bah.saj.am.util.MyContextWrapper
...
//    }
    ...
    private fun runTun2socks() {
        // مهم نیست تنظیمات کاربر چیست، همیشه از Tun2SocksService استفاده کن
        // این کار باعث جلوگیری از کرش JNI می‌شود
...
//        saveVpnNetworkInfo(configName, info)
        ...
        if (isForced) {
            //stopSelf has to be called ahead of mInterface.close(). otherwise saj core cannot be stooped
            //It's strage but true.
            //This can be verified by putting stopself() behind and call stopLoop and startLoop
            //in a row for several times. You will find that later created saj core report port in use
            //which means the first saj core somehow failed to stop and release the port.
            stopSelf()
